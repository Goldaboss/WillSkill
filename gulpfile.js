...
gulp.task('styles', function() { // Создаем таск "sass"
    return gulp.src('app/styles/style.scss') // Берем источник
        ...
        .pipe(gulp.dest('docs/styles')) // Выгружаем результата в папку docs/styles
...
gulp.task('watch', function() {
    ...
    gulp.watch('app/**/*.js', gulp.parallel('scripts')); // Наблюдение за главным JS файлом и за библиотеками
